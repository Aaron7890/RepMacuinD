...
">
    ...
    <div>
        ...
        <div class="col-md-4 d-flex align-items-center p-2">
            ...
            <span class="mb-3 mb-md-0 text-dark">&copy; 2023 sMacuinDashboards, Emp</span>
        </div>

        <ul class="nav col-md-4 justify-content-end list-unstyled d-flex p-2 {{request()->routeIS('inicio')}}">
